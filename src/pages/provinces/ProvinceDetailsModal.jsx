    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-[var(--color-bg-dark-modal)] text-[var(--color-white)] rounded-3xl max-w-lg w-full shadow-2xl border border-[var(--color-border-dark)] overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        <div className="flex items-center justify-between px-6 py-5 border-b border-[var(--color-border-dark)]">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[var(--color-info-dark-bg)] flex items-center justify-center">
              <IconComponent className="w-5 h-5 text-[var(--color-info-dark-text)]" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-[var(--color-white)] tracking-wide">Province Details</h3>
              <p className="text-xs text-[var(--color-text-secondary-dark)]">ID: #{province.id}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          <div>
            <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Province Name</span>
            <p className="text-base font-semibold text-[var(--color-white)] mt-1">{province.name}</p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Type</span>
              <p className="text-sm font-medium text-[var(--color-info-dark-text)] mt-1">{province.type}</p>
            </div>
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Population</span>
            ...
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Area</span>
              <p className="text-sm font-medium text-[var(--color-white)] mt-1 flex items-center gap-1.5">
                <Navigation className="w-3.5 h-3.5 text-[var(--color-text-secondary-dark)]" />
                {province.area}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Districts & Communes</span>
              <p className="text-sm font-medium text-[var(--color-white)] mt-1">
                {province.districts} Districts, {province.communes} Communes
              </p>
            </div>
            <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--color-text-secondary-dark)]">Rating & Places</span>
              <p className="text-sm font-medium text-[var(--color-warning-dark-text)] mt-1 flex items-center gap-1">
                <Star className="w-3.5 h-3.5 fill-[var(--color-warning-dark-text)]" />
          ...
          <div className="bg-[var(--color-surface-hover-dark)]/50 p-3.5 rounded-2xl border border-[var(--color-border-dark)]">
            ...
            <p className="text-sm text-[var(--color-text-secondary-dark)] mt-1">{province.description}</p>
          </div>
        </div>
