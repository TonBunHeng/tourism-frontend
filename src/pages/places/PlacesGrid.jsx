      ...
      {places.length > 0 ? (
        places.map((place) => (
          <div
            ...
            className="bg-[var(--color-white)] dark:bg-[var(--color-bg-dark)]/50 border border-[var(--color-border-subtle-light)] dark:border-[var(--color-border-dark)] rounded-md p-4 hover:shadow-lg transition-all duration-200 group cursor-pointer"
          >
